            ...
            <div class="-m-1.5 overflow-x-auto">
                <div class="p-1.5 min-w-full inline-block align-middle">
                    ...
                    <div class="flex items-center justify-end mt-2">
                        <a class="inline-block px-3 py-2 bg-orange-900 rounded-lg text-sm sm:text-base text-white hover:text-stone-500 " href="/add-new-product">
                            + Add 
                        </a>
                    </div>
